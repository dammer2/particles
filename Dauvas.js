// U. Dammer. Version 1.9 Liestal  3.1.2021
...
oder bei mehreren Tasten gleichzeitig 
var keysPressed;
...
function move(){
	if (keysPressed && keysPressed[37]) {car.alpha-=1; }
	if (keysPressed && keysPressed[39]) {car.alpha+=1;}
	if (keysPressed && keysPressed[38]) goForward(1);
	if (keysPressed && keysPressed[40]) goBack(1);
}

weitere Events (Maus, ....) bei https://www.w3schools.com/graphics/game_controllers.asp
